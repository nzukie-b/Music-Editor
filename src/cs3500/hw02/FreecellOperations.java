...
public interface FreecellOperations<K> {
  ...
  /**
   *
   * <p>Return a valid and complete deck of cards for a game of Freecell. There is
   * no restriction imposed on the ordering of these cards in the deck.</p>
   *
   * <p>An invalid deck is defined as a deck that has one or more of these
   * flaws:</p>
   * <ul>
  ...
  /**
   * <p>Deal a new game of freecell with the given deck, with or without shuffling
   * it first. This method first verifies that the deck is valid.</p>
   *
   ...
   * the move is valid. A card cannot be moved from a Foundation Pile.
   *
